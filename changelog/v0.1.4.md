...
| Issue | Pull request | Relationship | Result proposed for `main` |
| --- | --- | --- | --- |
| [#47](https://github.com/yenhao-huang/npu_in_pynq/issues/47) | [#52](https://github.com/yenhao-huang/npu_custom/pull/52) | Promotion and integration follow-up | Promote Phase 2A/2B and remove the delivery test superseded by #48 |
