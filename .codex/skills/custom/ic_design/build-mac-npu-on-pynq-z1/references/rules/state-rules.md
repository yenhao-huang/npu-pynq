...
For a new independent run, reset `STATE.md` from
...
`skipped`. Record exact files, commands, test counts, and blockers before
marking a step complete. Never put credentials in state.
