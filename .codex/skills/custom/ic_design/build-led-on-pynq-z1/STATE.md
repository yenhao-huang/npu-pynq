...
Instance: npu_repo_in_pynq/.codex/skills/custom/ic_design/build-led-on-pynq-z1
Started: 2026-08-07
...
| 2. Execute Workflow | completed | Moved to `.codex/skills/custom/ic_design`; added required rules and state template; removed initializer-generated `agents/`. | Existing domain references were preserved. |
...
| 4. Handoff Summary | completed | Canonical skill path is `npu_repo_in_pynq/.codex/skills/custom/ic_design/build-led-on-pynq-z1`. | Ready for repository-local use. |
