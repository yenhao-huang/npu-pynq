...
if (p[13]) k=4'd13;
case(k)
4'd6:ex=$signed(es)-7'sd21;
4'd7:ex=$signed(es)-7'sd20;
4'd8:ex=$signed(es)-7'sd19;
4'd9:ex=$signed(es)-7'sd18;
4'd10:ex=$signed(es)-7'sd17;
4'd11:ex=$signed(es)-7'sd16;
4'd12:ex=$signed(es)-7'sd15;
4'd13:ex=$signed(es)-7'sd14;
default:ex=-7'sd25;endcase
nf=0;sf=0;
case(k)
4'd6:nf={p[5:0],1'b0};
