...
For example, issue 142 claimed by agent `a` uses `npu/issue142-a`. Keep
`agent-id` short, stable, and lowercase for the issue; do not include a tool or
vendor name. Create or attach one dedicated worktree outside the primary checkout,
