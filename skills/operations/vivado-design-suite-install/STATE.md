...
Instance: npu_repo_in_pynq/skills/operations/vivado-design-suite-install
Started: 2026-08-07
...
| 2. Execute Workflow | completed | Moved to `skills/operations`; normalized the state template to the shared five-step schema. | Domain references and SKILL.md were preserved. |
...
| 4. Handoff Summary | completed | Canonical skill path is `npu_repo_in_pynq/skills/operations/vivado-design-suite-install`. | Ready for repository-local use. |
