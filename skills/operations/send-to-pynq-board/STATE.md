...
Instance: npu_repo_in_pynq/skills/operations/send-to-pynq-board
Started: 2026-08-07
...
| 2. Execute Workflow | completed | Moved from the legacy project-local skill tree to `skills/operations`; updated command, filetree, and state-template paths. | The old empty skill tree was removed. |
...
| 4. Handoff Summary | completed | Canonical skill path is `npu_repo_in_pynq/skills/operations/send-to-pynq-board`. | Ready for repository-local use. |
